...
def serving_tail_drop_nodes(FEL0, FEL1, num, final_time, prob):
	serve_count = 0
...
def tail_drop_simulation(prob):
	...
	return serving_tail_drop_nodes(FEL0, FEL1, FEL0_size+FEL1_size, curr_time, prob)
